...
const Icons = {
  ...
  workflows: (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M10 2 4 10h4l-1 6 6-8H9l1-6z"/>
    </svg>
  ),
  preview: (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function LeftNav() {
  ...
  const codeView = (view: 'explorer' | 'git' | 'search' | 'tests' | 'workflows') => {
  ...
  return (
    ...
    >
      ...
      <NavIcon icon={Icons.workflows} active={onCode && leftPanelOpen && leftPanelView === 'workflows'} title="Workflows"                  onClick={() => codeView('workflows')} />
