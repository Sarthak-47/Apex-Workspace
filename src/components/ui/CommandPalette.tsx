...
export function CommandPalette({ onClose }: Props) {
  ...
  const commands = useMemo<AppCommand[]>(() => {
    ...
    return [
      ...
      { id: 'c:ai-ask', title: 'Terminal: Ask AI for a Command', run: run(() => store.openTerminalAi('ask')) },
      { id: 'c:ai-explain', title: 'Terminal: Explain a Command with AI', run: run(() => store.openTerminalAi('explain')) },
      { id: 'c:ai-fix', title: 'Terminal: Fix a Failing Command with AI', run: run(() => store.openTerminalAi('fix')) },
